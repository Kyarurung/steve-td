...
final class EndStatsView {
    ...
    static List<String> core(CoreStats stats) {
        ...
        lines.add("<#D94343>피해량 상한(최종 피해 제외): " + compactOneDecimal(combat.maximumAttackDamage()) + "</#D94343>");
        ...
        lines.add("<#E66F6F>추가 체력: " + oneDecimal(defense.additionalHealth()) + "</#E66F6F><white> / </white><#79C97B>재생: " + Math.round(defense.currentRegeneration()) + " / " + Math.round(defense.maximumRegeneration()) + "/초</#79C97B>");

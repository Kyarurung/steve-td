...
public final class SuccubusTowers {
    public static final TowerType DREAM_DUST_T1 = tower("succubus_dream_dust_t1", "꿈가루 타워", 45, 65, 7, 7, 18, 0, EntityType.ALLAY,
            List.of("<gray>공격을 반복해 적에게 꿈을 쌓습니다.</gray>", "<light_purple>{ability.stackEvery:integer}번째 적중마다 꿈 1스택을 부여합니다.</light_purple>"));
    public static final TowerType DREAM_DUST_T2 = tower("succubus_dream_dust_t2", "짙은 꿈가루 타워", 100, 105, 8, 13, 16, 0, EntityType.ALLAY,
            DREAM_DUST_T1.description());
    public static final TowerType DREAM_DUST_T3 = tower("succubus_dream_dust_t3", "심층 꿈가루 타워", 210, 155, 9, 23, 14, 0, EntityType.ALLAY,
            DREAM_DUST_T1.description());
    ...
    public static final TowerType SLEEPWALKER_T1 = tower("succubus_sleepwalker_t1", "몽유 타워", 50, 190, 2.5, 4, 20, 80, PURPLE_SHEEP,
            List.of("<gray>공격을 받아 꿈을 되돌려주는 전방 타워입니다.</gray>",
                    ...
                    "<light_purple>공격자에게 {ability.counterCooldownTicks:seconds}마다 꿈 1스택을 부여합니다.</light_purple>"));
    ...
    public static final TowerType NIGHTMARE_T1 = tower("succubus_nightmare_t1", "악몽 타워", 65, 70, 8, 14, 20, 0, EntityType.PHANTOM,
    ...
    public static final TowerType NIGHTMARE_T2 = tower("succubus_nightmare_t2", "가위눌림 타워", 135, 110, 9, 26, 18, 0, EntityType.PHANTOM,
            NIGHTMARE_T1.description());
    public static final TowerType NIGHTMARE_T3 = tower("succubus_nightmare_t3", "심연의 악몽 타워", 270, 160, 10, 46, 16, 0, EntityType.PHANTOM,
            NIGHTMARE_T1.description());

    public static final TowerType SUCCUBUS = TowerType.builder("succubus", "서큐버스 타워")
            .mineralCost(500).maxHealth(160).range(8).damage(18).attackIntervalTicks(16).aggroPriority(20)
    ...
    private static TowerType support(String id, String name, long cost, double health, int interval,
                                     EntityVisual visual, double radius, int targets) {
        return tower(id, name, cost, health, 0, 0, interval, -5, visual, List.of(
                "<gray>주변 아군과 적에게 함께 꿈을 들려주는 지원 타워입니다.</gray>",
                "<light_purple>{ability.pulseIntervalTicks:seconds}마다 반경 {ability.radius:blocks}의 아군과 적 최대 {ability.maxTargets:integer}기에게 꿈 1스택을 부여합니다.</light_purple>"
        ));
    }

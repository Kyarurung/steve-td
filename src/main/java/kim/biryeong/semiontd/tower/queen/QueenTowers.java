...
public final class QueenTowers {
    public static final TowerType QUEEN = TowerType.builder("queen", "붉은 여왕")
            ...
            .description(List.of(
                    "가장 강한 적에게 축소 {ability.queen_global.queenShrinkPoints:number}을 가해 최대체력·공격력·크기를 원본의 {ability.queen_global.minimumStatScale:percent}까지 낮춥니다.",
                    ...
                    "자이언트가 현재 체력 {ability.queen_global.giantInitialExecutionHealth:number} 이하의 적을 <dark_red>처형</dark_red>하며, 처형선은 경기 동안 제한적으로 성장합니다.",
    ...
    public static final TowerType RANDOM_CARD_SOLDIER = TowerType.builder("queen_random_card_soldier", "무작위 카드병정")
            ...
            .description(List.of(
                    ...
                    "공격할 때 축소 {ability.queen_global.cardShrinkPoints:number}을 누적해 원본의 {ability.queen_global.minimumStatScale:percent}까지 낮추고, 반경 {ability.queen_global.cardSplashRadius:blocks}의 추가 적 {ability.queen_global.cardSplashExtraTargets:int}기도 약화합니다. 사망 시 반경 {ability.queen_global.cardDeathRadius:blocks}에 축소 {ability.queen_global.cardDeathShrinkPoints:number}을 남깁니다.",

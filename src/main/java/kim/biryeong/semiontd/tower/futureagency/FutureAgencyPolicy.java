...
public enum FutureAgencyPolicy {
    AGENCY_TACTICS("agency_tactics", "기관 전술 교리", "모든 요원 피해 +8%", 3, 0.08),
    ...
    EVAC_MEDICS("evac_medics", "긴급 철수 의료반", "생존 이월 시 최대 HP 10% 회복", 3, 0.10),
    WAVE_ANALYSIS("wave_analysis", "웨이브 전술분석실", "자연 웨이브 피해 +12%", 3, 0.12),
    INCOME_INTERCEPTION("income_interception", "인컴 요격실", "인컴 피해 +12%", 3, 0.12),
    RANGED_ARMOR("ranged_armor", "원거리 방호복", "원거리 피해 -15%", 2, 0.15),
    MELEE_TRAINING("melee_training", "근접 대응훈련", "근접 피해 -12%", 2, 0.12),
    CENTRAL_BATTLE("central_battle", "중앙 결전 계획", "구원 후 중앙 방어 피해 +20%", 1, 0.20),
    ANOMALY_DEPARTMENT("anomaly_department", "특이괴물대책과 창설", "워든 피해 -35%", 1, 0.35),
    TANK_DEPARTMENT("tank_department", "중장갑 대책과", "TANK 피해 +25%", 1, 0.25),
    SIEGE_DEPARTMENT("siege_department", "공성체 대책과", "SIEGE 피해 +25%", 1, 0.25),
    SWARM_DEPARTMENT("swarm_department", "군집체 대책과", "SWARM·RUSH 피해 +20%", 1, 0.20),
    PROFESSIONAL_AGENTS("professional_agents", "전문요원훈련과 창설", "모든 요원 피해 감소 10%", 1, 0.10),
    PRECISION_FIRE("precision_fire", "정밀사격 교범", "전투 요원 피해 +15%", 3, 0.15),
    FAST_RELOAD("fast_reload", "고속 재장전", "전투 요원 공속 +10%", 3, 0.10),
    LONG_RANGE_OPTICS("long_range_optics", "장거리 광학장비", "전투 요원 사거리 +1", 2, 1.0),
    EXECUTION_AUTHORITY("execution_authority", "처형 승인", "체력 30% 이하 피해 +30%", 1, 0.30),
    HIGH_VALUE_TARGET("high_value_target", "고가치 표적 지정", "최대 HP 500 이상 피해 +25%", 1, 0.25),
    AREA_SUPPRESSION("area_suppression", "광역 제압탄", "제압 반경 +0.4", 3, 0.40),
    RESTRAINT_ROUNDS("restraint_rounds", "강화 구속탄", "제압 감속 +7.5%p", 3, 0.075),
    MULTI_TARGET("multi_target", "다중 표적 교리", "제압 대상 +1", 3, 1.0),
    DISPERSION_WARHEAD("dispersion_warhead", "확산 탄두", "제압 범위 피해 +10%p", 2, 0.10),
    DENSE_CONTROL("dense_control", "밀집 진압 절차", "주변 적당 피해 +2%, 최대 +30%", 1, 0.02),
    CERAMIC_PLATES("ceramic_plates", "세라믹 장갑판", "방호 요원 최대 HP +20%", 3, 0.20),
    SHOCK_ABSORPTION("shock_absorption", "충격 흡수복", "방호 피해 감소 +8%p", 3, 0.08),
    FORCED_TAUNT("forced_taunt", "강제 유인 신호기", "방호 어그로 +25", 2, 25.0),
    ESCORT_FORMATION("escort_formation", "호위 대형", "주변 요원 피해 감소 10%", 1, 0.10),
    LAST_BARRIER("last_barrier", "최후 방벽", "체력 35% 이하 피해 감소 +25%p", 1, 0.25);

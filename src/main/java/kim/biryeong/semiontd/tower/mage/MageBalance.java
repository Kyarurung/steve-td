...
public final class MageBalance {
    ...
    public static final double MANA_BOMB_DAMAGE = 105.0;
    ...
    public static final double FROST_WAVE_DAMAGE = 60.0;
    ...
    public static final double DIMENSIONAL_COLLAPSE_DAMAGE = 380.0;

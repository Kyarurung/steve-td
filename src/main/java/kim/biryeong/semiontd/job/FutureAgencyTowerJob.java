...
public final class FutureAgencyTowerJob extends SemionJob {
    ...
    public FutureAgencyTowerJob() {
        super(ID, Component.literal("미래기관 빌더"), List.of(
                SemionText.mini("<gray>고비용 <gold>정책</gold>과 <aqua>생존 이월</aqua>로 병력을 누적하는 후반 왕귀형 빌더입니다.</gray>")));
    }
    ...
    public List<Component> description() {
        return List.of(
                ...
                SemionText.mini("<gray>라인을 살아서 정리한 요원은 그 위치·체력으로 <aqua>추가 생존자</aqua>가 되고, 설치 원본도 다음 웨이브에 다시 출전합니다.</gray>"),

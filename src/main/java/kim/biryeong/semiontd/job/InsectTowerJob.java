...
public final class InsectTowerJob extends SemionJob {
    ...
    public List<Component> description() {
        return List.of(
                SemionText.mini("새로 배치한 기본 벌레는 <gold>처음 참여하는 웨이브</gold>에 체력과 피해가 2.5배입니다."),
                SemionText.mini("살아 있는 자기 <light_purple>스포너</light_purple> 반경 안에서 죽으면 3초 뒤 그 자리에서 <green>부활</green>합니다."),
                SemionText.mini("같은 라운드에 다시 죽을수록 부활이 2초씩 늦어지고 <red>받는 피해</red>가 10%씩 증가합니다."),

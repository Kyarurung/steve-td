...
public final class UndeadTowerJob extends SemionJob {
    ...
    public UndeadTowerJob() {
        super(
                ...
                List.of(
                        SemionText.mini("<green><bold>시작</bold></green> <gray>좀비를 앞에 세우고 해골을 뒤에서 지원하세요.</gray>"),
                        SemionText.mini("<aqua><bold>운영</bold></aqua> <gray>흡혈과 부활로 버티며 주변 적과 타워의 죽음을 해골 강화에 활용하세요.</gray>")
                )
        );
    }

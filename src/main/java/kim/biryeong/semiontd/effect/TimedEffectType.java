...
public enum TimedEffectType {
    ...
    MONSTER_TOWER_DAMAGE_TAKEN_BONUS(SummonBalancePolicy.MAX_MONSTER_TOWER_DAMAGE_TAKEN_BONUS),
    MONSTER_MOVE_SPEED_BONUS(SummonBalancePolicy.MAX_MONSTER_MOVE_SPEED_BONUS),
    MONSTER_MOVE_SPEED_REDUCTION(SummonBalancePolicy.MAX_MONSTER_MOVE_SPEED_REDUCTION),
    MONSTER_ATTACK_DAMAGE_BONUS(SummonBalancePolicy.MAX_MONSTER_ATTACK_DAMAGE_BONUS),
    MONSTER_ATTACK_DAMAGE_REDUCTION(SummonBalancePolicy.MAX_MONSTER_ATTACK_DAMAGE_REDUCTION),
    MONSTER_ATTACK_SPEED_BONUS(SummonBalancePolicy.MAX_MONSTER_ATTACK_SPEED_BONUS),
    MONSTER_ATTACK_SPEED_REDUCTION(SummonBalancePolicy.MAX_MONSTER_ATTACK_SPEED_REDUCTION);

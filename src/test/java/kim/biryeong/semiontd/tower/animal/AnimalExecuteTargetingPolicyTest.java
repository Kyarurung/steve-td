...
class AnimalExecuteTargetingPolicyTest {
    @Test
    void selectsLowestHealthRatioExecuteCandidateInAttackRange() {
        ...
        var selected = AnimalExecuteTargetingPolicy.select(
    ...
    void ignoresHealthyAndOutOfRangeTargets() {
        ...
        var selected = AnimalExecuteTargetingPolicy.select(List.of(healthy, lowOutOfRange), 0.30);
    ...
    void tiesByDistanceAfterHealthRatio() {
        ...
        var selected = AnimalExecuteTargetingPolicy.select(List.of(far, close), 0.30);
    ...
    void stackThresholdIsCapped() {
        double threshold = AnimalExecuteTargetingPolicy.effectiveThreshold(0.40, 10, 0.05, 0.60);

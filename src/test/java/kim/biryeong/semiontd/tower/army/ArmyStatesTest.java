...
class ArmyStatesTest {
     ...
     *
     * <p>Per-slot effectiveness was derived with the permanent bonus fixed at +200%: a ten-slot
    ...
    void medalCapKeepsTheFamilyWithinItsBudget() {
        ...
        assertEquals(2.0, ArmyStates.medalBonus(PLAYER), 1.0E-9,
                "permanent bonus is budgeted at exactly +200%; re-derive per-slot output before changing it");
    }
}
